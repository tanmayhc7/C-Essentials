...
In the second iteration, we will move two pointers until they points to the same node. Our operations in first iteration will help us counteract the difference. So if two linkedlist intersects, 
...
ll* getIntersectionNode(ll *headA, ll *headB) {
    ll* t1=headA;
    ll* t2=headB;
